...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->loginSuccess((*reinterpret_cast< std::add_pointer_t<std::shared_ptr<User>>>(_a[1]))); break;
        ...
        {
            using _t = void (LoginWindow::*)(std::shared_ptr<User> );
...
// SIGNAL 0
void LoginWindow::loginSuccess(std::shared_ptr<User> _t1)
{
